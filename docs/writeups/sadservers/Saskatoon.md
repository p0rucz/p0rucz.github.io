...
Como mencione antes, la ip `32.0.1700.107` queda descartada, pero igualmente haremos la comprobación, el hash esperado deberia ser `6ef426c40652babc0d081d438b9f353709008e93` y como se puede observar no coincide.

```ruby
admin@ip-172-31-27-155:~$ sha1sum highestip.txt 
0de411a22db0ab346a18aee0feccdfb40dbd57a0  highestip.txt
```
Ahora comprobaremos con `66.249.73.135` y como se puede observar el hash coincide con el que nos otorgo sadservers.
...
![solución](../../assets/images/writeups/sadservers/saskatoon/solution.webp) 
